...
#         file = './data/output/prediciton_results/preciction_results_whole_data_baseflow_index.rds')
...
#         file = './data/output/prediciton_results/preciction_results_geol_clustering_baseflow_index.rds')
# 
...
# 
# saveRDS(object = prediction_results_cluster, 
#         file = './data/output/prediciton_results/preciction_results_soil_clustering_baseflow_index.rds')
# 
# selected_data_slope_fdc[, cluster_hc := NULL]
# rm(prediction_results_cluster, data_for_prediction)
# 
...
# 
# saveRDS(object = prediction_results_cluster, 
#         file = './data/output/prediciton_results/preciction_results_topo_clustering_baseflow_index.rds')
# 
# selected_data_slope_fdc[, cluster_hc := NULL]
# rm(prediction_results_cluster, data_for_prediction)
# 
...
saveRDS(object = prediction_results_cluster,
        file = './data/output/prediciton_results/preciction_results_vege_clustering_baseflow_index.rds')
...
saveRDS(object = prediction_results_cluster, 
        file = './data/output/prediciton_results/preciction_results_climate_clustering_baseflow_index.rds')
...
length(list.files(path = './data/output/prediciton_results'))
