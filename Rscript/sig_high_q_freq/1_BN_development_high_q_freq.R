################################################################################
#                                                                              #
#                       learn causal graph for high q freq                     #
#                                PC Algorithm                                  #
# ##############################################################################
...
parents(x = pc.fit, node = 'high_q_freq')
graphviz.plot(pc.fit)
saveRDS(object = pc.fit, file = './data/output/PC_DAGs/pc_mi_g_sh_hqf.rds')
graphviz.plot(readRDS(file = './data/output/PC_DAGs/pc_mi_g_sh_hqf.rds'))
...
saveRDS(object = pc_boot_strength, file = './data/output/PC_DAGs/boot_pc_mi_g_sh_hqf.rds')
...
dt_hqd_reg_test <- 
  readRDS(file = './data/output/regression_test/likelihood_ratio_test_high_q_freq')
...
# CPDAG to DAG-----------------------------------------------------------------
pc.fit <- readRDS(file = './data/output/PC_DAGs/pc_mi_g_sh_hqf.rds')
parents(x = pc.fit, node = 'high_q_freq')
plot(pc.fit)
pc.fit
...
saveRDS(object = pc.fit, file = './data/output/PC_DAGs/DAG_hqf.rds')
