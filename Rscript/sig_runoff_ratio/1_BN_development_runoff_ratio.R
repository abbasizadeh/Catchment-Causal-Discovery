################################################################################
#                                                                              #
#                       learn causal graph for runoff ratio                    #
#                                PC Algorithm                                  #
# ##############################################################################
...
parents(x = pc.fit, node = 'runoff_ratio')
graphviz.plot(pc.fit)

saveRDS(object = pc.fit, file = './data/output/PC_DAGs/pc_mi_g_sh_rr.rds')
graphviz.plot(readRDS(file = './data/output/PC_DAGs/pc_mi_g_sh_rr.rds'))
...
saveRDS(object = pc_boot_strength, file = './data/output/PC_DAGs/boot_pc_mi_g_sh_rr.rds')
...
dt_hqd_reg_test <- 
  readRDS(file = './data/output/regression_test/likelihood_ratio_test_runoff_ratio')
...
# CPDAG to DAG-----------------------------------------------------------------
pc.fit <- readRDS(file = './data/output/PC_DAGs/pc_mi_g_sh_rr.rds')
parents(x = pc.fit, node = 'runoff_ratio')
...
saveRDS(object = pc.fit, file = './data/output/PC_DAGs/DAG_rr.rds')
