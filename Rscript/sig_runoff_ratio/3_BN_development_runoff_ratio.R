...
# transform to normal
# write.csv(x = selected_data_slope_fdc, file = './results_text/runoff_ratio/data_runoff_ratio.csv')
...
pc.fit <- set.arc(pc.fit, from = 'geol_porosity', to = 'runoff_ratio')

pc.fit <- set.arc(pc.fit, from = 'lai_max', to = 'frac_forest')

pc.fit <- set.arc(pc.fit, from = 'frac_forest', to = 'runoff_ratio')
...
pc.fit <- set.arc(pc.fit, from = 'p_mean', to = 'runoff_ratio')
pc.fit <- set.arc(pc.fit, from = 'p_mean', to = 'p_seasonality')
pc.fit <- set.arc(pc.fit, from = 'p_mean', to = 'lai_max')

pc.fit <- set.arc(pc.fit, from = 'p_seasonality', to = 'runoff_ratio')
