...
# write.csv(x = selected_data_slope_fdc, file = './results_text/low_q_freq/data_low_q_freq.csv')
...
pc.fit <- set.arc(pc.fit, from = 'frac_forest', to = 'low_q_freq')
...
pc.fit <- set.arc(pc.fit, from = 'low_prec_freq', to = 'low_prec_dur')
pc.fit <- set.arc(pc.fit, from = 'low_prec_freq', to = 'low_q_freq')

pc.fit <- set.arc(pc.fit, from = 'high_prec_freq', to = 'low_prec_freq')

pc.fit <- set.arc(pc.fit, from = 'frac_snow', to = 'low_q_freq')

pc.fit <- set.arc(pc.fit, from = 'p_seasonality', to = 'low_prec_dur')
pc.fit <- set.arc(pc.fit, from = 'p_seasonality', to = 'frac_forest')


pc.fit <- set.arc(pc.fit, from = 'low_prec_dur', to = 'low_q_freq')
