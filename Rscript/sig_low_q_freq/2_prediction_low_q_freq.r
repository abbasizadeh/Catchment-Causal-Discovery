...
pc.fit <- readRDS('./data/output/PC_DAGs/DAG_lqf.rds')
...
#         file = './data/output/prediciton_results/preciction_results_whole_data_low_q_freq.rds')
# 
...
#         file = './data/output/prediciton_results/preciction_results_geol_clustering_low_q_freq.rds')
# 
...
# 
# saveRDS(object = prediction_results_cluster, 
#         file = './data/output/prediciton_results/preciction_results_soil_clustering_low_q_freq.rds')
# 
# selected_data_slope_fdc[, cluster_hc := NULL]
# rm(prediction_results_cluster, data_for_prediction)
# 
...
# 
# saveRDS(object = prediction_results_cluster, 
#         file = './data/output/prediciton_results/preciction_results_topo_clustering_low_q_freq.rds')
# 
# selected_data_slope_fdc[, cluster_hc := NULL]
# rm(prediction_results_cluster, data_for_prediction)
# 
...
# 
# saveRDS(object = prediction_results_cluster, 
#         file = './data/output/prediciton_results/preciction_results_vege_clustering_low_q_freq.rds')
# 
# selected_data_slope_fdc[, cluster_hc := NULL]
# rm(prediction_results_cluster, data_for_prediction)
...
saveRDS(object = prediction_results_cluster, 
        file = './data/output/prediciton_results/preciction_results_climate_clustering_low_q_freq.rds')
