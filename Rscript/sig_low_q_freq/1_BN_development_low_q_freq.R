################################################################################
#                                                                              #
#                       learn causal graph for low q freq                      #
#                                PC Algorithm                                  #
# ##############################################################################
...
parents(x = pc.fit, node = 'low_q_freq')
saveRDS(object = pc.fit, file = './data/output/PC_DAGs/pc_mi_g_sh_lqf.rds')
graphviz.plot(readRDS(file = './data/output/PC_DAGs/pc_mi_g_sh_lqf.rds'))
...
saveRDS(object = pc_boot_strength, file = './data/output/PC_DAGs/boot_pc_mi_g_sh_lqf.rds')
...
dt_hqd_reg_test <- 
  readRDS(file = './data/output/regression_test/likelihood_ratio_test_low_q_freq')
...
# CPDAG to DAG-----------------------------------------------------------------
pc.fit <- readRDS(file = './data/output/PC_DAGs/pc_mi_g_sh_lqf.rds')
parents(x = pc.fit, node = 'low_q_freq')
plot(pc.fit)
...
saveRDS(object = pc.fit, file = './data/output/PC_DAGs/DAG_lqf.rds')
