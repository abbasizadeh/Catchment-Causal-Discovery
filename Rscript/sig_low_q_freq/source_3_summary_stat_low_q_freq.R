...
whole_data_stat <- fread(
  paste0(
    './data/output/summary_stat/low_q_freq/summary_stat_whole_clust_',
    target_node,
    '.csv'
  )
)
...
# # predictors -------------------------------------------------------------------
# pred_stat <- fread(paste0('./data/output/summary_stat/low_q_freq/summary_stat_predictors_clust_', target_node,'.csv'))
# head(pred_stat)
# 
# pred_stat[, V1 := NULL]
# 
...
clim_stat <- fread(
  paste0(
    './data/output/summary_stat/low_q_freq/summary_stat_climate_clust_',
    target_node,
    '.csv'
  )
)
...
write.csv(
  clim_results,
  file = paste0(
    './data/output/summary_stat/low_q_freq/weighted_climate_clust_overal_results_',
    target_node,
    '.csv'
  )
)
...
geol_stat <- fread(
  paste0(
    './data/output/summary_stat/low_q_freq/summary_stat_geol_clust_',
    target_node,
    '.csv'
  )
)
...
write.csv(
  geol_results,
  file = paste0(
    './data/output/summary_stat/low_q_freq/weighted_geol_clust_overal_results_',
    target_node,
    '.csv'
  )
)
...
soil_stat <- fread(
  paste0(
    './data/output/summary_stat/low_q_freq/summary_stat_soil_clust_',
    target_node,
    '.csv'
  )
)
...
write.csv(
  soil_results,
  file = paste0(
    './data/output/summary_stat/low_q_freq/weighted_soil_clust_overal_results_',
    target_node,
    '.csv'
  )
)
...
topo_stat <- fread(
  paste0(
    './data/output/summary_stat/low_q_freq/summary_stat_topo_clust_',
    target_node,
    '.csv'
  )
)
...
# summary_stat_climate_overal_results.csv
write.csv(topo_results, file = paste0('./data/output/summary_stat/low_q_freq/weighted_topo_clust_overal_results_', target_node, '.csv'))
...
vege_stat <- fread(
  paste0(
    './data/output/summary_stat/low_q_freq/summary_stat_vege_clust_',
    target_node,
    '.csv'
  )
)
...
write.csv(
  vege_results,
  file = paste0(
    './data/output/summary_stat/low_q_freq/weighted_vege_clust_overal_results_',
    target_node,
    '.csv'
  )
)
...
write.csv(
  whole_data_results,
  file = paste0(
    './data/output/summary_stat/low_q_freq/weighted_whole_clust_overal_results_',
    target_node,
    '.csv'
  )
)
