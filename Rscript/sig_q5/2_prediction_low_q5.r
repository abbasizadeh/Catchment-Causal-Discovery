...
# baseflow index ---------------------------------------------------------------
target_node <- 'q5'
pc.fit <- readRDS('./data/output/PC_DAGs/DAG_q5.rds')
...
saveRDS(object = prediction_results_whole_data, 
        file = './data/output/prediciton_results/preciction_results_whole_data_q5.rds')
...
saveRDS(object = prediction_results_cluster, 
        file = './data/output/prediciton_results/preciction_results_geol_clustering_q5.rds')
...
saveRDS(object = prediction_results_cluster, 
        file = './data/output/prediciton_results/preciction_results_soil_clustering_q5.rds')
...
saveRDS(object = prediction_results_cluster, 
        file = './data/output/prediciton_results/preciction_results_topo_clustering_q5.rds')
...
saveRDS(object = prediction_results_cluster, 
        file = './data/output/prediciton_results/preciction_results_vege_clustering_q5.rds')
...
saveRDS(object = prediction_results_cluster, 
        file = './data/output/prediciton_results/preciction_results_climate_clustering_q5.rds')
