...
prediction_results_predictors <- 
  readRDS(paste0('./results_data/preciction_results_predictors_clustering_', target_node,'.rds'))
...
prediction_results_predictors[cluster_label == 'whole_dataset', 
                                   cluster_label := 'whole dataset; 671 catchments']
...
prediction_results_cluster_climate <- 
  readRDS(paste0('./results_data/preciction_results_climate_clustering_', target_node, '.rds'))
...
# soil cluster -----------------------------------------------------------------
prediction_results_cluster_soil <- readRDS(paste0('./results_data/preciction_results_soil_clustering_', target_node,'.rds'))
...
# topography cluster -----------------------------------------------------------
prediction_results_cluster_topo <- readRDS(paste0('./results_data/preciction_results_topo_clustering_', 
                                                  target_node, '.rds'))
...
prediction_results_cluster_vege <- 
  readRDS(paste0('./results_data/preciction_results_veg_clustering_', target_node,'.rds'))
...
prediction_results_whole_cluster <- 
  readRDS(paste0('./results_data/preciction_results_whole_data_clustering_', target_node,'.rds'))
