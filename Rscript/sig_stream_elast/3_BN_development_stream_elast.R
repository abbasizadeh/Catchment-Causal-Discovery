...
data_slope_fdc_scaled <- as.data.table(lapply(data_slope_fdc[, -15], scale))
...
pc.fit <- set.arc(pc.fit, from = 'slope_mean', to = 'frac_snow')
pc.fit <- set.arc(pc.fit, from = 'p_seasonality', to = 'frac_snow')
...
pc.fit <- set.arc(pc.fit, from = 'low_prec_dur', to = 'low_prec_freq')

pc.fit <- set.arc(pc.fit, from = 'low_prec_dur', to = 'high_prec_freq')
pc.fit <- set.arc(pc.fit, from = 'frac_snow', to = 'lai_max')

pc.fit <- set.arc(pc.fit, from = 'low_prec_freq', to = 'high_prec_freq')
...
pc.fit <- set.arc(pc.fit, from = 'p_seasonality', to = 'frac_forest')
pc.fit <- set.arc(pc.fit, from = 'frac_snow', to = 'frac_forest')

pc.fit <- set.arc(pc.fit, from = 'p_seasonality', to = 'low_prec_dur')
