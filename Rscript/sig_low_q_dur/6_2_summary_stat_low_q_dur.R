...
# whole dataset ----------------------------------------------------------------
whole_data_stat <- fread(paste0('./results_data/summary_stat_whole_clust_', target_node, '.csv'))
whole_stat <-
...
# climate ----------------------------------------------------------------------
clim_stat <- fread(paste0('./results_data/summary_stat_climate_clust_', target_node,'.csv'))
head(clim_stat)
...
# summary_stat_climate_overal_results.csv
write.csv(clim_results, file = paste0('./results_data/weighted_climate_clust_overal_results_', target_node, '.csv'))

# geology ----------------------------------------------------------------------
geol_stat <- fread(paste0('./results_data/summary_stat_geology_clust_', target_node, '.csv'))
...
# summary_stat_climate_overal_results.csv
write.csv(geol_results, file = paste0('./results_data/weighted_geol_clust_overal_results_', target_node,'.csv'))


# soil ----------------------------------------------------------------------
soil_stat <- fread(paste0('./results_data/summary_stat_soil_clust_', target_node, '.csv'))
head(soil_stat)
...
write.csv(soil_results, file = paste0('./results_data/weighted_soil_clust_overal_results_', target_node, '.csv'))


# topo -------------------------------------------------------------------------
topo_stat <- fread(paste0('./results_data/summary_stat_topo_clust_', target_node, '.csv'))
...
# summary_stat_climate_overal_results.csv
write.csv(topo_results, file = paste0('./results_data/weighted_topo_clust_overal_results_', target_node, '.csv'))



# vege -------------------------------------------------------------------------
vege_stat <- fread(paste0('./results_data/summary_stat_vege_clust_', target_node, '.csv'))
...
# summary_stat_climate_overal_results.csv
write.csv(vege_results, file = paste0('./results_data/weighted_vege_clust_overal_results_', target_node, '.csv'))
...
# summary_stat_climate_overal_results.csv
write.csv(whole_data_results, file = paste0('./results_data/weighted_whole_clust_overal_results_', target_node, '.csv'))
