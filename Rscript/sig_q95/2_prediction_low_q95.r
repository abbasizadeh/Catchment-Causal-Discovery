...
# baseflow index ---------------------------------------------------------------
target_node <- 'q95'
pc.fit <- readRDS('./data/output/PC_DAGs/DAG_q95.rds')
...
#         file = './data/output/prediciton_results/preciction_results_whole_data_q95.rds')
# 
...
#         file = './data/output/prediciton_results/preciction_results_geol_clustering_q95.rds')
# 
...
# 
# saveRDS(object = prediction_results_cluster, 
#         file = './data/output/prediciton_results/preciction_results_soil_clustering_q95.rds')
# 
# selected_data_slope_fdc[, cluster_hc := NULL]
# rm(prediction_results_cluster, data_for_prediction)
# 
...
# 
# saveRDS(object = prediction_results_cluster, 
#         file = './data/output/prediciton_results/preciction_results_topo_clustering_q95.rds')
# 
# selected_data_slope_fdc[, cluster_hc := NULL]
# rm(prediction_results_cluster, data_for_prediction)
# 
...
# 
# saveRDS(object = prediction_results_cluster, 
#         file = './data/output/prediciton_results/preciction_results_vege_clustering_q95.rds')
# 
# selected_data_slope_fdc[, cluster_hc := NULL]
# rm(prediction_results_cluster, data_for_prediction)
...
saveRDS(object = prediction_results_cluster, 
        file = './data/output/prediciton_results/preciction_results_climate_clustering_q95.rds')
