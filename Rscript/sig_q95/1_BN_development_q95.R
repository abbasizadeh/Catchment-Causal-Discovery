...
parents(x = pc.fit, node = 'q95')
graphviz.plot(pc.fit)
saveRDS(object = pc.fit, file = './data/output/PC_DAGs/pc_mi_g_q95.rds')
graphviz.plot(readRDS(file = './data/output/PC_DAGs/pc_mi_g_q95.rds'))
...
saveRDS(object = pc_boot_strength, file = './data/output/PC_DAGs/boot_pc_mi_g_sh_q95.rds')
...
dt_hqd_reg_test <- 
  readRDS(file = './data/output/regression_test/likelihood_ratio_test_q95')
...
# CPDAG to DAG-----------------------------------------------------------------
pc.fit <- readRDS(file = './data/output/PC_DAGs/pc_mi_g_q95.rds')
parents(x = pc.fit, node = 'q95')
plot(pc.fit)
pc.fit
...
saveRDS(object = pc.fit, file = './data/output/PC_DAGs/DAG_q95.rds')
