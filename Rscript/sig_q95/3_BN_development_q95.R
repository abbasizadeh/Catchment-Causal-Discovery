...
# transform to normal
# write.csv(x = selected_data_slope_fdc, file = './results_text/q95/data_q95.csv')
...
# pc.fit <- set.arc(pc.fit, from = 'geol_porosity', to = '')

pc.fit <- set.arc(pc.fit, from = 'lai_max', to = 'frac_forest')

pc.fit <- set.arc(pc.fit, from = 'frac_forest', to = 'q95')
...
pc.fit <- set.arc(pc.fit, from = 'slope_mean', to = 'q95')
...
pc.fit <- set.arc(pc.fit, from = 'gauge_lat', to = 'high_prec_freq')
...
pc.fit <- set.arc(pc.fit, from = 'clay_frac', to = 'frac_forest')
