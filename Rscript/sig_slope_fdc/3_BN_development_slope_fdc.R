...
# data processing --------------------------------------------------------------
# write.csv(x = selected_data_slope_fdc, file = './results_text/slope_fdc/data_slope_fdc.csv')
...
# pc.fit <- set.arc(pc.fit, from = 'geol_porosity', to = 'elev_mean')
pc.fit <- set.arc(pc.fit, from = 'frac_forest', to = 'lai_max')

pc.fit <- set.arc(pc.fit, from = 'slope_mean', to = 'clay_frac')
...
pc.fit <- set.arc(pc.fit, from = 'elev_mean', to = 'geol_porosity')
...
pc.fit <- set.arc(pc.fit, from = 'gauge_lat', to = 'slope_mean')
pc.fit <- set.arc(pc.fit, from = 'gauge_lat', to = 'low_prec_freq')

pc.fit <- set.arc(pc.fit, from = 'high_prec_dur', to = 'lai_max')
pc.fit <- set.arc(pc.fit, from = 'high_prec_dur', to = 'low_prec_freq')
