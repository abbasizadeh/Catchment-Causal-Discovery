...
# write.csv(sum_res, file = './results_data/summary_stat_climate_clust_slope_fdc.csv')
# write.csv(sum_res, file = './results_data/summary_stat_geology_clust_slope_fdc.csv')
# write.csv(sum_res, file = './results_data/summary_stat_soil_clust_slope_fdc.csv')
# write.csv(sum_res, file = './results_data/summary_stat_topo_clust_slope_fdc.csv')
# write.csv(sum_res, file = './results_data/summary_stat_vege_clust_slope_fdc.csv')
# write.csv(sum_res, file = './results_data/summary_stat_whole_clust_slope_fdc.csv')
write.csv(sum_res, file = './results_data/summary_stat_predictors_clust_slope_fdc.csv')
