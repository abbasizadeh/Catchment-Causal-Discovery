...
prediction_results_whole_data <- readRDS('./results_data/preciction_results_whole_data_slope_fdc.rds')
...
prediction_results_predictors <- 
  readRDS('./results_data/preciction_results_predictors_clustering_slope_fdc.rds')
...
prediction_results_predictors[cluster_label == 'whole_dataset', 
                                   cluster_label := paste0('whole dataset; ', sum(cluster_number_predictors$n),' catchments')]
...
# climate cluster --------------------------------------------------------------
prediction_results_cluster_climate <- readRDS('./results_data/preciction_results_climate_clustering_slope_fdc.rds')
...
# geological cluster -----------------------------------------------------------
prediction_results_cluster_geol <- readRDS('./results_data/preciction_results_geol_clustering_slope_fdc.rds')
...
prediction_results_cluster_geol[cluster_label == 'whole_dataset', 
                                cluster_label := paste0('whole dataset; ', sum(cluster_number_geol$n),' catchments')]
...
# soil cluster -----------------------------------------------------------------
prediction_results_cluster_soil <- readRDS('./results_data/preciction_results_soil_clustering_slope_fdc.rds')
...
prediction_results_cluster_soil[cluster_label == 'whole_dataset', 
                                cluster_label := paste0('whole dataset; ', sum(cluster_number_soil$n),' catchments')]
...
# topography cluster -----------------------------------------------------------
prediction_results_cluster_topo <- readRDS('./results_data/preciction_results_topo_clustering_slope_fdc.rds')
...
prediction_results_cluster_topo[cluster_label == 'whole_dataset', 
                                cluster_label := paste0('whole dataset; ', sum(cluster_number_topo$n),' catchments')]
...
prediction_results_cluster_vege <- readRDS('./results_data/preciction_results_veg_clustering_slope_fdc.rds')
...
prediction_results_cluster_vege[cluster_label == 'whole_dataset', 
                                cluster_label := paste0('whole dataset; ', sum(cluster_number_vege$n),' catchments')]
...
prediction_results_whole_cluster <- readRDS('./results_data/preciction_results_whole_data_clustering_slope_fdc.rds')
