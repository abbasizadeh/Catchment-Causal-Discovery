...
write.csv(
  sum_res, 
  file = paste0('./data/output/summary_stat/slope_fdc/summary_stat_climate_clust_', target_node,'.csv'))

# geology
sum_res <- fun_summary_stat(dt = prediction_results_cluster_geol)
write.csv(
  sum_res, 
  file = paste0('./data/output/summary_stat/slope_fdc/summary_stat_geol_clust_', target_node,'.csv'))

# soil
sum_res <- fun_summary_stat(dt = prediction_results_cluster_soil)
write.csv(
  sum_res, 
  file = paste0('./data/output/summary_stat/slope_fdc/summary_stat_soil_clust_', target_node,'.csv'))

# topo
sum_res <- fun_summary_stat(dt = prediction_results_cluster_topo)
write.csv(
  sum_res, 
  file = paste0('./data/output/summary_stat/slope_fdc/summary_stat_topo_clust_', target_node,'.csv'))
...
write.csv(
  sum_res, 
  file = paste0('./data/output/summary_stat/slope_fdc/summary_stat_vege_clust_', target_node,'.csv'))
...
write.csv(
  sum_res, 
  file = paste0('./data/output/summary_stat/slope_fdc/summary_stat_whole_clust_', target_node,'.csv'))
