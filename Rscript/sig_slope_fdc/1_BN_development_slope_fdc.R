################################################################################
#                                                                              #
#                       learn causal graph for slope FDC                       #
#                                PC Algorithm                                  #
# ##############################################################################
...
# saveRDS(object = pc.fit, file = './data/output/PC_DAGs/pc_mi_g_sh_slope_fdc.rds')
parents(x = pc.fit, node = 'slope_fdc')
graphviz.plot(pc.fit)
graphviz.plot(readRDS(file = './data/output/PC_DAGs/pc_mi_g_sh_slope_fdc.rds'))
pc.fit
...
saveRDS(object = pc_boot_strength, file = './data/output/PC_DAGs/boot_pc_mi_g_sh_slope_fdc.rds')
...
dt_hqd_reg_test <- 
  readRDS(file = './data/output/regression_test/likelihood_ratio_test_slope_fdc')
...
# CPDAG to DAG-----------------------------------------------------------------
pc.fit <- readRDS(file = './data/output/PC_DAGs/pc_mi_g_sh_slope_fdc.rds')
parents(x = pc.fit, node = 'slope_fdc')
plot(pc.fit)
pc.fit
...
saveRDS(object = pc.fit, file = './data/output/PC_DAGs/DAG_slope_fdc.rds')
