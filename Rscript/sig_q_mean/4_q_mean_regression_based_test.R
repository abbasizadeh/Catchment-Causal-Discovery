...
# pc.fit$learning
# parents_nodes <- parents(x = pc.fit, node = 'q_mean')
# set.seed(1)
...
# 7
selected_data_slope_fdc <- selected_data_slope_fdc[, -c('low_prec_freq', "elev_mean")]
target_node_1 <- 'p_mean'
target_node_2 <- 'q_mean'
