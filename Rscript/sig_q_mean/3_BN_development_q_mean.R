...
# transform to normal
# write.csv(x = selected_data_slope_fdc, file = './results_text/q_mean/data_q_mean.csv')
...
pc.fit <- set.arc(pc.fit, from = 'area_gages2', to = 'p_seasonality')
...
# 
pc.fit <- set.arc(pc.fit, from = 'low_prec_freq', to = 'q_mean')
# 
pc.fit <- set.arc(pc.fit, from = 'pet_mean', to = 'low_prec_freq')
